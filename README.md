...
<div dir="rtl" align="right">
  ...
  <h2>📊 آخرین اطلاعات</h2>
  <p><strong>آخرین به‌روزرسانی:</strong> 1404/06/15 | <strong>قیمت ثبت شده:</strong> 1,022,900 ریال ↗️</p>
  <p><strong>تغییر نسبت به روز قبل:</strong> +3,650 ریال</p>
  <p><strong>تعداد ردیف‌های CSV:</strong> 12,794</p>
