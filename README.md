...
<div dir="rtl" align="right">
  ...
  <h2>📊 آخرین اطلاعات</h2>
  <p><strong>آخرین به‌روزرسانی:</strong> 1404/10/09 | <strong>قیمت ثبت شده:</strong> 1,383,400 ریال ↘️</p>
  <p><strong>تغییر نسبت به روز قبل:</strong> -13,300 ریال</p>
  <p><strong>تعداد ردیف‌:</strong> 12,891</p>
